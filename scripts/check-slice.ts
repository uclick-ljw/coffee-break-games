...
import { SLICE_SHAPES, makeSliceChallenges, polygonArea, rankSlices, scoreSlice, splitPolygon } from '../app/slice-game.ts';
...
console.log('slice game checks passed: 8 shapes, exact area split, valid ranking');

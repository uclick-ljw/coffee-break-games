...
export const GAMES: readonly GameInfo[] = [
  ...
  },
  {
    ...
    controls: '남은 범위 안에서 숫자 하나를 누르면 UP·DOWN 단서가 나옵니다.', result: '폭탄 숫자를 누르거나 준비 후 6초를 넘긴 사람이 패배합니다. 기기를 넘기는 동안에는 시간이 줄지 않습니다.',
  },
  {
  ...
  },
  {
    ...
    controls: '시작을 누르고 감으로 기다린 뒤 다시 눌러 시간을 멈추세요.', result: '0.01초 단위 목표 오차가 작은 순서입니다. 같은 오차는 공동 순위입니다.',
  },
  {
    ...
    controls: '회전하는 판을 보고 발사 버튼을 눌러 정해진 위치에서 쏘세요.', result: '성공 수 → 적은 충돌 → 짧은 발사 시간(0.1초 단위) 순서입니다. 같은 기록은 공동 순위입니다.',
  },
  {
    ...
    controls: '동물을 손가락으로 누른 채 화면 안에서 자유롭게 움직이세요.', result: '0.01초 단위 생존 시간이 긴 순서입니다. 같은 기록은 공동 순위입니다.',
  },
  {
    ...
    controls: '우주선을 누르고 밀어 추력의 방향과 세기를 조절하세요.', result: '착륙 정확도와 충격 점수의 합계로 순위를 정합니다. 같은 점수는 공동 순위입니다.',
  },
  {
    ...
    controls: '차를 누른 채 좌우로 움직여 조향하고, 손을 떼면 급정거합니다.', result: '주차 위치와 각도를 평가한 점수가 높은 순서입니다. 같은 점수는 공동 순위입니다.',
  },
  {
    ...
    controls: '목표 수위를 기억한 뒤 주전자를 누르고 기울여 한 번에 따르세요.', result: '세 잔의 합계 점수 → 작은 평균 부피 오차 순서입니다. 같은 기록은 공동 순위입니다.',
  },
  {
    ...
    controls: '빈 캔버스를 손가락으로 누른 채 끝까지 한 번에 그리세요.', result: '모양과 비율의 유사도 점수가 높은 순서입니다. 같은 점수는 공동 순위입니다.',
  },
  {
    id: 'slice', category: 'eye', icon: '🍠', artClass: 'slice-card-art', kicker: '눈대중과 부피 감각', title: '반으로 쓱',
    description: '비대칭 물체를 한 줄로 잘라 정확한 50:50을 만드세요.', action: '반 나누기',
    players: '2~6명', time: '약 1분', goal: '울퉁불퉁한 물체의 부피를 정확히 반으로 나누세요.',
    controls: '3D 물체를 살펴본 뒤 손가락으로 절단선 하나를 그으세요.', result: '두 조각의 부피 차이로 계산한 점수가 높은 순서입니다. 같은 점수는 공동 순위입니다.',
  },
  {
    ...
    controls: '좌우·상하 회전 버튼으로 살펴본 뒤 물체를 눌러 한 점을 고르세요.', result: '세 번의 평균 거리 오차가 작은 순서입니다. 0.1% 단위 평균 오차가 같으면 공동 순위입니다.',
  },
  {
    ...
    controls: '조형물을 손가락으로 밀어 3D 방향을 바꾸고 제출하세요.', result: '그림자 일치율 → 빠른 제출(0.1초 단위) 순서입니다. 같은 기록은 공동 순위입니다.',
  },
  {
    ...
    controls: '컵의 움직임을 눈으로 따라간 뒤 정답이라고 생각한 컵을 누르세요.', result: '3라운드 정답 수 → 합계 점수 → 빠른 선택(0.1초 단위) 순서입니다. 모두 오답이거나 같은 기록이면 공동 순위입니다.',
  },
  {
  ...
  },
  {
    ...
    controls: '방향 타일을 눌러 회전시키고 도둑의 다음 경로를 바꾸세요.', result: '탈출 성공이 우선입니다. 성공끼리는 100점에서 초당 2점·회전당 5점을 뺍니다. 실패끼리는 마지막 안전칸의 출구 접근률로 비교하며, 같은 기록은 공동 순위입니다.',
  },
  {
    ...
    controls: '음식을 끌어 옮기고 눌러 회전하며, 놓은 뒤에도 다시 배치할 수 있습니다.', result: '채운 면적 → 빠른 제출(0.1초 단위) 순서입니다. 반찬 개수는 순위에 영향을 주지 않으며 같은 기록은 공동 순위입니다.',
  },
  {

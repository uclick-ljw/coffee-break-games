...
const CONFIG = {
  ...
  untangle: { title: '엉킨 선 풀어라', icon: '🪢', kicker: '복잡한 건 선, 단순한 건 조작', hook: <>점을 옮기면,<br />길이 보일 거예요.</>, rule: '동그란 점을 끌어 선이 서로 교차하지 않게 만드세요. 빨간 선은 아직 엉켜 있고, 파란 선은 안전합니다.', rank: '남은 교차 수가 적을수록 우승 · 모두 풀면 시간 비교', tip: '25초 도전 · 점은 겹칠 수 없어요', unit: '곳', start: '선 엉키기' },
